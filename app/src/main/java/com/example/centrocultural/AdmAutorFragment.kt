...
class AdmAutorFragment : Fragment(), ObraAdapter.OnItemClickListener, TextToSpeech.OnInitListener{
    ...
    companion object{
        ...
        fun newInstance(autor: Autor):AdmAutorFragment{
            val fragmento =AdmAutorFragment()
            val args = Bundle()
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_adm_autor, container, false)
        ...
        btn_remove = view.findViewById(R.id.remove_button)


        pop_up = Dialog(requireContext())

        btn_edit.setOnClickListener(){
            (requireActivity() as AdmMainActivity).openFragmentEditAutor(autor)
        }
        btn_remove.setOnClickListener(){
            pop_up.setContentView(R.layout.adm_delete_pop_up)
            var txt_popup = pop_up.findViewById<TextView>(R.id.text_popup)
            txt_popup.text = "Tem certeza de que deseja remover o autor ${autor.nome}?"
            ...
            sim_btn.setOnClickListener(){
                Utilidades.removerElemento("autores",autor.id)
                Utilidades.alterarAutorObras(autor_obras,autor.nome,"")
