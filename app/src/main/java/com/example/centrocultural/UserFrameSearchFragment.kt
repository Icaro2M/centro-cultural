...
class UserFrameSearchFragment : Fragment(), userSeachObras.OnSearchListener, userSeachAutores.OnSearchListener {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_user_frame_search, container, false)
    ...
    private fun onSb_frame_btnClicked(){
        ...
        replaceFragment(userSeachObras(),"obras")
    ...
    private fun onSb_person_btnClicked(){
        ...
        estado = "autores"
        replaceFragment(userSeachAutores(),"autores")
    ...
    override fun onSearch(query: String) {
        ...
        if(estado=="obras"){
            ...
            val fragmento = childFragmentManager.findFragmentByTag(estado) as? userSeachObras
            Log.e("Creation",fragmento.toString())
            fragmento?.search(query)
        }else{
            val fragmento = childFragmentManager.findFragmentByTag(estado) as? userSeachAutores
    ...
    private fun askSpeechInputs(){
        if(!SpeechRecognizer.isRecognitionAvailable(requireContext())){
            ...
            i.putExtra(RecognizerIntent.EXTRA_PROMPT,"Fale alguma coisa")
                ...
                requireActivity().startActivityForResult(i,(requireActivity() as MainActivity).RQ_SPEECH_REC)
        }
    }
