...
class UserObraFragment : Fragment(), TextToSpeech.OnInitListener {
    ...
    companion object{
        ...
        fun newInstance(obra:Obra):UserObraFragment{
            val fragmento = UserObraFragment()
            val args = Bundle()
    ...
    override fun onCreateView(
        ...
        val view =  inflater.inflate(R.layout.fragment_user_obra, container, false)
        ...
        val array = (requireActivity() as MainActivity).databaseAutores
